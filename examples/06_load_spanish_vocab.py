...
into a local SQLite database, and runs a short interactive
quiz. Progress is persisted between runs so spaced-repetition
scheduling works across sessions.
...
def main() -> None:
    ...
    if fresh:
        ...
        print(f"Using existing database: {_DB_PATH}\n")
